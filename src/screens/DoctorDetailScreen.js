              ...
              <div className="order-2 md:order-1 lg:order-1 flex flex-col justify-center">
                ...
                <div className="flex items-center justify-center md:justify-start lg:justify-start space-x-6 pt-8">
                  <h1 className="text-3xl font-bold text-black poppins select-none">
                    ${(doctor.price * quantity).toFixed(2)}
                  </h1>
                  {/* quantity  */}
                  <div className="flex items-center border border-gray-200 px-4 py-2 space-x-6 rounded-full">
                    <AiOutlineMinus
                      onClick={() => {
                        ...
                        // setOrderPrice(doctor.price * quantity);
                        // doctor.price = orderPrice;
                      }}
                      className="text-2xl bg-green-400 w-8 h-8 rounded-full text-white hover:scale-105 transform transition duration-500 cursor-pointer p-1"
                    />
                ...
                <div className="mt-8 flex items-center justify-center md:justify-start lg:justify-start">
                  <button
                    ...
                    className={
                      disabled
                        ...
                        : "flex items-center space-x-3 bg-green-400 px-6 py-3 text-white poppins rounded-full ring-red-300 focus:outline-none focus:ring-4 transform transition duration-700 hover:scale-105"
                    }
                    onClick={() => {
                      doctor["quantity"] = quantity;
                      doctor.price = doctor.price * quantity;
                      handleOrder(doctor);
                      setDisabled(true);
                      swal(
                        "Wow!!!",
                  ...
                  >
                    ...
                    <span>{disabled ? "Added" : "save places"}</span>
                  </button>
                </div>
              </div>
              {/* right side  */}
